...
export default function ProfileGate({
  ...
  const body = (
    <div className="w-full max-w-lg">
      ...
      <div className="mb-8 text-center">
        ...
        <h1 className="mt-4 font-display text-[1.9rem] leading-tight text-ink">
        ...
        <p className="mt-2 text-[0.9rem] text-muted">
          Perfis locais neste aparelho — favoritos, notas e progresso separados.
        </p>
      </div>
      ...
      {pinFor ? (
        <div className="panel mx-auto max-w-xs p-6 text-center">
          ...
          <input
            ...
            className={cx(
              "code mt-2 w-full rounded-lg border bg-surface-2 px-4 py-3 text-center text-[1.4rem] tracking-[0.4em] text-ink outline-none",
              pinError ? "border-cortical" : "border-line focus:border-teal",
            )}
            placeholder="••••"
          />
          {pinError && <p className="mt-2 text-[0.8rem] text-cortical">PIN incorreto.</p>}
        ...
        <div className="panel mx-auto max-w-sm p-6">
          ...
          <input
            ...
            className="mt-2 w-full rounded-lg border border-line bg-surface-2 px-4 py-3 text-[0.95rem] text-ink outline-none focus:border-teal"
          />
          ...
          <input
            ...
            className="code mt-2 w-full rounded-lg border border-line bg-surface-2 px-4 py-3 tracking-[0.3em] text-ink outline-none focus:border-teal"
          />
  ...
  if (overlay) {
    return (
      <div className="fixed inset-0 z-[70] grid place-items-center overflow-y-auto bg-bg/92 p-6 backdrop-blur-sm">
        {activeId && (
          <button
            type="button"
            onClick={onClose}
