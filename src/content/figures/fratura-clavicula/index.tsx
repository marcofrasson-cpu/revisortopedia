...
const Anatomia: FC<FigureProps> = ({ className, title }) => (
  ...
  >
    ...
    <text x="300" y="72" style={mono}>art. acromioclavicular</text>
    <text x="292" y="164" style={label}>lig. coracoclaviculares</text>
    <text x="30" y="158" style={label}>lig. costoclavicular</text>
    <text x="150" y="188" style={label}>plexo braquial + a./v. subclávias (posteroinferior)</text>
    ...
    >
      ...
      {v === "2B" && (
        <>
          ...
          <text x="80" y="52" style={label}>2B — desvio / cominuição (cunha) → maior risco de pseudartrose</text>
        </>
      )}
      <text x="20" y="188" style={label}>Tipo 1 = medial · Tipo 2 = diafisário · Tipo 3 = lateral (A: alinhado · B: desviado)</text>
    </svg>
  );
};
...
const Acesso: FC<FigureProps> = ({ className, title }) => (
  ...
  >
    ...
    <text x="150" y="192" style={label}>plexo braquial + a./v. subclávias — não perfurar a cortical posterior</text>
  </svg>
);
...
const Step1: FC<FigureProps> = ({ className, title }) => (
  ...
  >
    ...
    <text x="130" y="172" style={mono}>tração → restaurar comprimento e rotação</text>
  </svg>
);
...
const Step2: FC<FigureProps> = ({ className, title }) => (
  ...
  >
    ...
    <text x="150" y="150" style={label}>parafuso interfragmentar (lag) na obliquidade</text>
...
const Step3: FC<FigureProps> = ({ className, title }) => (
  ...
  >
    ...
    <text x="60" y="164" style={label}>menor agressão de partes moles · risco de migração/perfuração</text>
  </svg>
);
