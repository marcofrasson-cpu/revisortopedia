...
export const topic = defineTopic({
      ...
      types: [
        {
          ...
          description:
            "Separação através da fise proximal, com ou sem luxação da epífise do acetábulo. Corresponde a cerca de 8% dos casos. É o tipo mais raro e o mais grave: a necrose chega a ~45% quando a epífise permanece reduzida e aproxima-se de 100% quando há luxação associada. Distinguir do escorregamento epifisário femoral proximal agudo, que ocorre em adolescente sem trauma de alta energia. No recém-nascido e no lactente, considerar trauma obstétrico ou maus-tratos.",
  ...
  complications: [
    ...
    },
    {
      name: "Condrólise",
      detail:
        "Rara nesta fratura, ao contrário do que ocorre na epifisiólise femoral proximal. Quase sempre iatrogênica, por penetração articular não reconhecida do implante. Cursa com rigidez progressiva e dor, com estreitamento do espaço articular na radiografia.",
      prevention:
